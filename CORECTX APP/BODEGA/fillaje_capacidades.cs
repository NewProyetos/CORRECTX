...
{
    public partial class fillaje_capacidades : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        public fillaje_capacidades()
        {
            InitializeComponent();
        }
       ...
       GridSummaryItem  total_arti;
        GridSummaryItem total_valor,Total_peso,Total_volume;
        
        private void fillaje_capacidades_Load(object sender, EventArgs e)
        {
            ...
            barStaticItem2.Caption = Login.usuario.ToUpper();
        ...
        {
            string FileName = "C:\\CORRECT\\XLS\\fill_Rate.xlsx";
