...
{
    public partial class InterfaceDMS : Form
    {
        public InterfaceDMS()
        {
        ...
        private void InterfaceDMS_Load(object sender, EventArgs e)
        {
        ...
        public void procesamiento()
        {
            ...
            for (int i = 0; i < sucursales.Rows.Count; i++)
            {
                ...
                {
                    fecha_facini = dateTimePicker1.Value.ToString("yyyy/MM/dd");
                    fecha_facfin = dateTimePicker2.Value.ToString("yyyy/MM/dd");
                }
        ...
        private void ImportRegionUserWorker_DoWork(object sender, DoWorkEventArgs e)
        {
        ...
        private void ImportRegionUserWorker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            if (Proceso == 1)
            {
                ImportStoreWorker.RunWorkerAsync();
            }
            else
            {
                validachek();
        ...
        private void ImportStoreWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            string[] direccion;
        ...
        private void ImportStoreWorker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            if (Proceso == 1)
            {
                ...
                ImportRouteWorker.RunWorkerAsync();
        ...
        private void IniciaWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            procesamiento();
        }

        private void ImportRouteWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            ImportRoute.Clear();
            con.conectar("EX");
        ...
        private void ImportRouteWorker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            if (Proceso == 1)
            {
                ImportStockWorker.RunWorkerAsync();
            }
            else
            {
                validachek();
        ...
        private void ImportStockWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            ImportStock.Clear();
            con.conectar("EX");
            SqlCommand cmd = new SqlCommand("[DISMOGT].[ImportStockV3]", con.conex);
        ...
        private void ImportStockWorker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            if (Proceso == 1)
            {
                ImportOrderInvoice.RunWorkerAsync();
            }
            else
            {
                validachek();
        ...
        private void ImportOrderInvoice_DoWork(object sender, DoWorkEventArgs e)
        {
        ...
        private void ImportOrderInvoice_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            if (Proceso==1)
            {
                ImportItemInvoiceType.RunWorkerAsync();
            }
            else
            {
                validachek();
        ...
        private void ImportItemInvoiceType_DoWork(object sender, DoWorkEventArgs e)
        {
        ...
        private void ImportItemInvoiceType_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            if (Proceso == 1)
            {
                ImportVisitWorker.RunWorkerAsync();
            }
            else
            {
                validachek();
        ...
        private void ImportVisitWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            ImportVisit.Clear();
            con.conectar("EX");
        ...
        private void ImportVisitWorker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
