...
namespace Sinconizacion_EXactus
{
    public partial class Rutas : Form
    {
        ...
        private void CLIENTE_UPDATE(object sender, EventArgs e)
        {
            ...
            if (menu_site == 1)
            {
               int idxu = dataGridView1.CurrentRow.Index;
                cliente_up = Convert.ToString(dataGridView1.Rows[idxu].Cells[1].Value);
                nombre_cli = Convert.ToString(dataGridView1.Rows[idxu].Cells[2].Value);

            }
            else if (menu_site == 2)
            { 
              int  idxu = dataGridView2.CurrentRow.Index;
                cliente_up = Convert.ToString(dataGridView2.Rows[idxu].Cells[2].Value);
                nombre_cli = Convert.ToString(dataGridView2.Rows[idxu].Cells[3].Value);
            }


            Sinconizacion_EXactus.CORECTX_APP.VENTAS.RUTERO.Informacion_Cliente cl = new CORECTX_APP.VENTAS.RUTERO.Informacion_Cliente(cliente_up);
        ...
        private void dataGridView1_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Right)
            {
                ...
                {
                    menu_site = 1;
                    menugrid.MenuItems[0].Enabled = true;
                    menugrid.MenuItems[1].Enabled = true;
                    menugrid.MenuItems[3].Enabled = true;
        ...
        private void MOVER(Object sender, System.EventArgs e)
        {
            ...
            CORECTX_APP.VENTAS.RUTERO.Cambio mov = new CORECTX_APP.VENTAS.RUTERO.Cambio(cliente,Ruta);
        ...
        {
            if (toolStripComboBox1.Text == "ESPECIAL")
            {
                comboBox2.Text = "A";
        ...
        private void clientesNoActualizadosEnFRToolStripMenuItem_Click(object sender, EventArgs e)
        {
            CORECTX_APP.VENTAS.RUTERO.clienes_no_fr no_fr = new CORECTX_APP.VENTAS.RUTERO.clienes_no_fr();
            no_fr.ShowDialog();
        }
        ...
        private void dataGridView2_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Right)
            {
                info = dataGridView2.HitTest(e.X, e.Y);
                if (info.Type == DataGridViewHitTestType.Cell)
                {
                    menu_site = 2;

                    menugrid.MenuItems[0].Enabled = false;
                    menugrid.MenuItems[1].Enabled = false;
                    menugrid.MenuItems[3].Enabled = false;
                    menugrid.Show(dataGridView2, new Point(e.X, e.Y));
                }
