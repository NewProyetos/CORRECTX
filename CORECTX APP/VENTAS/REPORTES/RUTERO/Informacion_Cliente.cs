...
namespace Sinconizacion_EXactus.CORECTX_APP.VENTAS.RUTERO
{
    ...
    {
        public Informacion_Cliente(string cliente)
        {
            InitializeComponent();
            clientes = cliente;
        }
        ...
        private void Informacion_Cliente_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand cm7 = new SqlCommand("SELECT [DETALLE_DIRECCION] FROM [EXACTUS].["+empresa+"].[CLIENTE] where CLIENTE = '"+ clientes + "' ", con.conex);
            ...
            cliente_fill(clientes);

            cargar_zona_cliente(clientes);
        ...
        private void update_cliente()
        {
            ...
            if (existe_direccion(detdirect))
            {
                ...
                cmd7.Parameters.Add("@CAMPO_1", SqlDbType.VarChar).Value = textBox7.Text ;                
            ...
            else
            {
                ...
                cmd3.Parameters.Add("@CAMPO_1", SqlDbType.VarChar).Value = textBox7.Text ;
            ...
            cmd8.CommandText = "UPDATE  [EXACTUS].["+empresa+ "].[CLIENTE] SET [NOMBRE]=@NOMBRE,[ALIAS]=@ALIAS,[CONTACTO] = @CONTACTO,[DIRECCION]=@DIRECCION,[DIR_EMB_DEFAULT] = @DIR_EMB_DEFAULT,[TELEFONO1]=@TELEFONO1,[TELEFONO2] = @TELEFONO2,[CONTRIBUYENTE]=@CONTRIBUYENTE,[TIPO_CONTRIBUYENTE]=@TIPO_CONTRIBUYENTE,[NIVEL_PRECIO] = @NIVEL_PRECIO,[ZONA]= @ZONA,[RUTA]=@RUTA,[VENDEDOR]=@VENDEDOR,[COBRADOR]= @COBRADOR,[RUBRO1_CLI]=@RUBRO1_CLI,[RUBRO2_CLI]=@RUBRO2_CLI,[RUBRO3_CLI]=@RUBRO3_CLI,[RUBRO4_CLI]=@RUBRO4_CLI,[RUBRO5_CLI]=@RUBRO5_CLI,[CLASE_DOCUMENTO]= @CLASE_DOCUMENTO , [USUARIO_ULT_MOD]=@USUARIO_ULT_MOD,RecordDate = @RecordDate,PAIS = @PAIS , FECHA_HORA_CREACION = @FECHA_HORA_CREACION WHERE CLIENTE = '" + clientes + "'";
            ...
            cmd8.Parameters.Add("@DIRECCION", SqlDbType.VarChar).Value = textBox7.Text;
            cmd8.Parameters.Add("@DIR_EMB_DEFAULT", SqlDbType.VarChar).Value = "ND";
            ...
            if (ES_NUEVO == "S")
            {
                cmd8.Parameters.Add("@FECHA_HORA_CREACION", SqlDbType.DateTime).Value = fecha_proceso;
            }
            else
            {
                cmd8.Parameters.Add("@FECHA_HORA_CREACION", SqlDbType.DateTime).Value =  fecha_creacion;
            }
        ...
        {
            con.conectar("EX");
            SqlCommand cm1 = new SqlCommand("SELECT CLIE.[NOMBRE],CLIE.[ALIAS],CLIE.[CONTACTO],CLIE.[DIRECCION],CLIE.[TELEFONO1],CLIE.[TELEFONO2],CLIE.[CONTRIBUYENTE],CLIE.[TIPO_CONTRIBUYENTE],CLIE.[NIVEL_PRECIO],ZON.NOMBRE as city,DEP.NOMBRE_DPTO, CLIE.[RUTA],CLIE.[VENDEDOR],CLIE.[COBRADOR],CLIE.[RUBRO1_CLI],CLIE.[RUBRO2_CLI],CLIE.[RUBRO3_CLI],CLIE.[RUBRO4_CLI],CLIE.[RUBRO5_CLI],CLIE.[CLASE_DOCUMENTO],CLIE.[FECHA_HORA_CREACION] FROM [EXACTUS].[" + empresa+"].[CLIENTE] as CLIE LEFT JOIN [EXACTUS].["+empresa+"].[ZONA] as ZON  on CLIE.ZONA = ZON.ZONA LEFT JOIN [DM].[CORRECT].[DEPARTAMENTOS ELS] as DEP  on LEFT(ZON.ZONA,2) = DEP.OTRO and dep.EMPRESA = '"+empresa+"' where CLIENTE = '" + Cliente + "'", con.conex);
            ...
            if (infoclie.Rows.Count > 0)
            {
                ...
                direcini = Convert.ToString(row["DIRECCION"]);
                textBox7.Text = direcini;
                ...
                fecha_creacion = Convert.ToString(row["FECHA_HORA_CREACION"]);
        ...
        private void radioButton4_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                if (comboBox9.Text == "" || comboBox10.Text == "")
                {
                }
                else
                {
                   
                    string dep = comboBox9.Text;
                    string muni = comboBox10.Text;
                    textBox7.Text = direcini + "," + muni.ToUpper() +"," + dep.ToUpper() ;
        ...
        private void radioButton3_CheckedChanged(object sender, EventArgs e)
        {
            if (radioButton3.Checked)
            {
                ...
                else
                {
                    string dep = comboBox9.Text;
                    string muni = comboBox10.Text;
                    textBox7.Text = direcini + "," + dep.ToUpper() + "," + muni.ToUpper();  ;
